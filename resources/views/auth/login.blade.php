    ...
    <div class="auth-box">
        ...
        <form action="{{ url('/login') }}" method="POST">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem">
                <label
                    style="font-size:0.82rem;color:var(--muted);display:flex;align-items:center;gap:0.4rem;cursor:pointer">
                    <input type="checkbox" name="remember"> Remember me
                </label>
                <a href="{{ route('password.request') }}" class="link" style="font-size:0.82rem">Forgot Password?</a>
            </div>
            <button type="submit" class="btn-gold">Login Karein →</button>
        </form>

        <div class="divider">Naya account banana hai? <a href="{{ route('register') }}" class="link">Register
                karein</a></div>
    </div>
</body>
