...
.stat-card {
    ...
    border-radius: 14px; padding:1.3rem; transition: transform 0.2s;
}
...
.badge.submitted  { background:rgba(59,130,246,0.15); color:var(--blue); }
...
.progress-bar { height:100%; background:linear-gradient(90deg,var(--gold),var(--gold-light)); border-radius:3px; }
