...
<body>
    <div class="top-strip">
        🔥 DailyWealth me welcome - Smart investing 🚀
    </div>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('withdrawals.index') }}"
                class="{{ request()->routeIs('withdrawals.*') ? 'active' : '' }}">
            ...
            @if (Auth::user()->is_admin)
                ...
                <a href="{{ route('admin.reviews.index') }}"
                    ...
                    @if ($pendingReviews > 0)
                        <span
                            style="margin-left:auto;background:var(--gold);color:#0A0C10;font-size:0.65rem;font-weight:700;padding:1px 7px;border-radius:50px">
                            {{ $pendingReviews }}
                        </span>
                    @endif
                </a>
